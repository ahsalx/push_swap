...
A Python script that replays the operations produced by push_swap and visualizes how the values move between stack a and stack b.
...
Check correctness with the 42 checker:

./push_swap [numbers...] | ./checker [numbers...]

Visualize the operations with the Python visualizer:
